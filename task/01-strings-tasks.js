 ...
 *   'I like legends', 'end' , 'end' => 'I like legs',
 *   'ABABAB','BA' => 'ABAB'
 */
function removeFirstOccurrences(str, value) {
    var iStart = str.indexOf(value);
    var str1 = str.slice(0, str.indexOf(value));
    var str2 = str.slice(iStart+value.length);
...
function getRectangleString(width, height) {
    ...
    function printRow(width, startChar, middleChar, endChar) {
    ...
    res += printRow(width, "└", "─", "┘");
    return res;
    // var line1 = String.fromCharCode(9484) + String.fromCharCode(9472).repeat(width-2) + String.fromCharCode(9488) + '\n';
    // var line2 = (String.fromCharCode(9474) + " ".repeat(width-2) + String.fromCharCode(9474) + "\n").repeat(height-2);
    // var line3 = String.fromCharCode(9492) + String.fromCharCode(9472).repeat(width-2) + String.fromCharCode(9496);
